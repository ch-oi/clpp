...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private com.naver.maps.map.MapFragment mapView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.naver.maps.map.MapFragment mapFragment = (com.naver.maps.map.MapFragment) fm.findFragmentById(R.id.fragment_map);
        if (mapFragment == null) {
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        infoWindow1.setAdapter(new InfoWindow.DefaultTextAdapter(null) {
            @NonNull
            @Override
        ...
        infoWindow2.setAdapter(new InfoWindow.DefaultTextAdapter(null) {
            @NonNull
            @Override
        ...
        infoWindow3.setAdapter(new InfoWindow.DefaultTextAdapter(null) {
            @NonNull
            @Override
            public CharSequence getText(@NonNull InfoWindow infoWindow) {
                return "벽강아트센터";
